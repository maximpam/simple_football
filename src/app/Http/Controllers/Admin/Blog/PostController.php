...
class PostController extends BaseController
{
    ...
    {
        $paginator = $this->blogPostsRepository->getAllwithPaginate(5);


        return view('admin.blog.index', compact('paginator'));
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit($id, BlogPostsRepository $blogPostsRepository)
    {
        $item = $blogPostsRepository->getEdit($id);
